            ...
            <div class="col">
                <div class="swiper hero-slider">
                    <div class="swiper-wrapper">
                        <?php $args = array('post_type' => 'post', 'cat' => 'in-slider', 'order' => 'DESC' ); ?>
                        <?php $blog = new WP_Query($args); ?>
                        <?php if ($blog->have_posts()) : ?>
                            <?php while ($blog->have_posts()) : $blog->the_post(); ?>
                                <?php echo '<div class="swiper-slide">'; ?>
                                    <?php $blog_banner = get_field( 'blog_banner' ); ?>
                                    <?php if ( $blog_banner ) : ?>
                                    <div class="blog-item" style="--bg_banner: url(<?php echo esc_url( $blog_banner['url'] ); ?>);">
                                    <?php endif; ?>
                                        <div class="caption">
                                            <div class="blog-date">
                                                <?php the_time('F j, Y'); ?>
        ...
        <div class="row">
            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12">
                <div class="latest-blogs">
                    <?php $args = array('post_type' => 'post','posts_per_page' => 5 ,'order' => 'DESC' ); ?>
                    <?php $blog = new WP_Query($args); ?>
                    <?php if ($blog->have_posts()) : ?>
                        <?php while ($blog->have_posts()) : $blog->the_post(); ?>
                            <?php echo '<div class="blog-item">'; ?>
                                <a href="<?php the_permalink(); ?>">
                                    <?php if( has_post_thumbnail() ) : ?>
                                        <?php the_post_thumbnail('blogThumbSmall'); ?>
                                    <?php endif; ?>
                                </a>
                                <div class="caption">
                                    <div class="social">
